...
def sol_profiles(exp_sphase,exp_2phase,To,Po):
    ...
    sk=pd.read_csv("/media/andres/DISPOSITIVO2/Mestrado/Andressss/final2/Resultscomparisonsdrpl/Mooreshock/Mooreshockshckmoore_schk.csv")
    exp=pd.read_csv("/media/andres/DISPOSITIVO2/Mestrado/Andressss/lowpress_drpl/Mooreres/MEXP.csv")
    expr=pd.read_csv("/media/andres/DISPOSITIVO2/Mestrado/Andressss/final2/Mooreradius.csv")
    ...
    plt.ylim(0.2,0.6)
    plt.plot(x_sol,Prat)
    plt.plot(exp["x"][:]/10,exp["ppo"],"o")
    

    plt.figure(3)
    plt.plot(expr["x"]/10,expr['rm'],"o")
