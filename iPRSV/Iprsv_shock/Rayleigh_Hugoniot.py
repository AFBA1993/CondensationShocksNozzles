...
f="Water"
P3=25596.7209185492
T3=296.0664245779256
u3=557.3414787982842

#c=fnd_CJS(P3,T3,u3,f)
Vcj=4.11440891
Pcj=38247.46070686022/100000
qr=0.9855305999000002
...
df.to_csv("/media/multiusers/DISPOSITIVO/Mestrado/Andressss/Final/IPRSV_RESULTS/Moses_iprsv/rhmoses.csv")


rlcj=Rayleigh_linesS(P3,T3,u3,qr-0.04,f)
rlcj={"rv":rlcj[0],"rp":rlcj[1]}
df=pd.DataFrame(rlcj,columns=["rv","rp"])
df.to_csv("/media/multiusers/DISPOSITIVO/Mestrado/Andressss/Final/IPRSV_RESULTS/Moses_iprsv/rhmosesCJ.csv")
"""
...
rh=pd.read_csv("/media/andres777/DISPOSITIVO/Mestrado/Andressss/Final/IPRSV_RESULTS/Moses_iprsv/rhmoses.csv")
rlcj=pd.read_csv("/media/andres777/DISPOSITIVO/Mestrado/Andressss/Final/IPRSV_RESULTS/Moses_iprsv/rhmosesCJ.csv")
...
plt.plot(rh["rv"][:],rh["rp"][:],"-")
plt.plot(rh["hv"],rh["hp"],"--")
plt.plot(rlcj["rv"],rlcj["rp"],"-")
...
plt.plot(rh["hv"],rh["hp"],"-",color="darkcyan",lw=2,label="Hugoniot")

plt.plot(rh["rv"][:],rh["rp"][:],"-",color="darkred",lw=1.5,label="Rayleigh")
plt.plot(rlcj["rv"],rlcj["rp"],"-",color="darkred",lw=1.5,label="")



plt.plot(V3,P3,"v",ms=10,color="forestgreen",label="Upstream state")
plt.plot(Vwd,Pwd,"o",ms=7,color="black",label="Weak detonation")
plt.plot(Vsd,Psd,"o",ms=7,color="slategrey",label="Strong detonation")
plt.plot(Vcj,Pcj,"^",ms=8,color="black",label="CJ-point")



plt.text(3.8,0.445,"$\\bf{J}$=$\\bf{J}$$_{US}$",fontsize=12,family=family)
plt.arrow(3.85,0.44,0,-0.015, width=0.00001,head_width=0.015, head_length=0.005,fc='k', ec='k')
plt.arrow(3.3,0.445,0,+0.015, width=0.00001,head_width=0.015, head_length=0.005,fc='k', ec='k')
plt.text(3.125,0.43,"$\\bf{J}$=0.98 $\\bf{J}$$_{US}$",fontsize=12,family=family)

plt.legend(frameon=False,prop=font)
plt.grid(color="gainsboro", linestyle='--', linewidth=.75)
#plt.savefig('/media/andres/DISPOSITIVO/Mestrado/aquivamosenlaescrita/Tesis maestria3/fig/Results/iprsv/iprsvRH.pdf')
