...
def sol_profiles(exp_sphase,exp_2phase,To,Po):
    ...
    exp=pd.read_csv("/media/andres777/DISPOSITIVO/Mestrado/Andressss/final2/RESULTADOSFINAL/exp417p.csv")
    #sk=pd.read_csv("/media/andres777/DISPOSITIVO/Mestrado/Andressss/final2/ResultsMosescomp/exp428/428schk/428schk_schk.csv")
    #exp=pd.read_csv("/media/andres777/DISPOSITIVO/Mestrado/Andressss/lowpress_drpl/Mosesres/Moses434/Mosesexp434.csv")
    exp=pd.read_csv("/media/andres777/DISPOSITIVO/Mestrado/Andressss/final2/RESULTADOSFINAL/exp434p.csv")
    ...
    #plt.plot(sk["x"]/100,sk["T"])
    
    plt.figure(2)
    plt.xlim(8.22/100,14/100)
    plt.ylim(0.2,0.6)
    plt.plot(x_sol,Prat)
    plt.plot(exp["x"][:]/100,exp["ppo"],"o")
...
l=pd.read_csv("/media/andres777/DISPOSITIVO/Mestrado/Andressss/final2/RESULTADOSFINAL/exp410p.csv")

plt.plot(exp["x"],exp["ppo"],"--")
plt.plot(l["x"],l["ppo"],"o")
"""
