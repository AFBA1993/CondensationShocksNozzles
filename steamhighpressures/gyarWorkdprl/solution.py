...
def sol_profiles(exp_sphase,exp_2phase,To,Po):
    exp=pd.read_csv("/media/andres777/DISPOSITIVO/Mestrado/Andressss/Higpress_drpl/res18b/exp18b.csv")
    sk=pd.read_csv("/media/andres777/DISPOSITIVO/Mestrado/Andressss/final2/ResultsHIGH/Result18b/Gyar18bschk/Gyarmth18b_schk.csv") 
...
def Deliver_res(sol,Folder2send,Name_Data):
    ...
    return df1_to_deliver, df2_to_deliver, df3_to_deliver, df4_to_deliver, df5_to_deliver, df6.to_csv(df6_to_deliver)
