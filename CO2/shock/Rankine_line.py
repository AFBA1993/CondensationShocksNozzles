...
P3=1858084.6871981197
T3=240.0136784434091
u3=258.4201452983547

prop3=Cool_PT(P3,T3,f,EoS)
V3=1/prop3[1]

#cj=fnd_CJS(P3,T3,u3,f,EoS)
cj=fnd_RHS(P3,T3,u3,0.967,f,EoS)
Vcj=cj[0]
Pcj=cj[1]/100000
...
hl=Hugoniotl(P3,T3,0,f,EoS)
rlcj=RayleighlS(0.967-0.025,P3,T3,u3,f,EoS)
P3=P3/100000
...
plt.arrow(0.011,28.5,0,+1.5,width=0.00001,head_width=0.000075, head_length=1,fc='k', ec='k')
plt.arrow(0.013,32,0,-1.5,width=0.00001,head_width=0.000075, head_length=1,fc='k', ec='k')
plt.text(0.010,27,"\u03C1u=0.96 (\u03C1u)$_{US}$",fontsize=12,family=family)
plt.text(0.012,33,"\u03C1u=(\u03C1u)$_{US}$",fontsize=12,family=family)


plt.legend(frameon=False,prop=font)
plt.grid(color="gainsboro", linestyle='--', linewidth=.75)
plt.savefig("/home/andres/Área de Trabalho/BACKUP/Mestrado/Andressss/Final/Bierco2results/Plotsbierco2/RHbierco2.pdf")
"""
