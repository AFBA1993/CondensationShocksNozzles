...
def sol_profiles(exp_sphase,exp_2phase,To,Po):
    exp=pd.read_csv("/media/andres/DISPOSITIVO/Mestrado/Andressss/Bierco2/co2res/bierexp.csv")
    sk=pd.read_csv("/media/andres/DISPOSITIVO/Mestrado/Andressss/final2/Bierco2results/bierco2schk/co2shckbierco2schk_schk.csv")
    exp=pd.read_csv("/media/andres/DISPOSITIVO/Mestrado/Andressss/final2/RESULTADOSFINAL/expbierco2p.csv")
